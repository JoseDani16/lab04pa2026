...
Apartamento::Apartamento(int codigo, const string& direccion, int numeroPuerta,
...
string Apartamento::getTipo() const { return "Apartamento"; }

string Apartamento::getDetalle() const {
    ostringstream oss;
